...
Todos estes métodos são chamado de MODAIS, ou seja, eles interrompem a execução do script aguardando
 que a interação com o usuário seja executada.

Existem duas limitações compartilhadas por todos estes métodos:

1. A localização exata da janela modal é determinada pelo navegador.
 Normalmente, é no centro.
2. A aparência exata da janela também depende do navegador. Não
 podemos modificá-lo.

*/ 

//Alert: Esse já conhecemos. Irá mostrar uma mensagem e esperar que o 
...
/*Confirm
O confirm irá mostrar uma mensagem na tela e esperar que o usuário acione o
 botão OK ou o botão Cancelar. O retorno irá depender do botão selecionado:
OK: True
Cancelar: False
*/
...
TAREFA:
Criar uma página que pergunte o nome da pessoa, a idade e o endereço e 
